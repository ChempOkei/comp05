...
<head>
  ...
  <title>Course Admin · Создать курс</title>
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .err{font-size:12px;color:#b91c1c;margin-top:6px;display:none}
...
<body>
  <div class="shell">
    ...
    if ($_GET[$key] && $_GET[$key]=='kc') {
      $sql = "INSERT INTO coursefrom VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    ?>
      <div class="card">
        <div class="cardbody">
          <form class="form" action="courses-list?key=kc" method="post" enctype="multipart/form-data" novalidate>
            <div class="grid">
              <div class="" id="nameField">
                ...
                <div class="err" id="nameError">Название обязательно</div>
              </div>
              <div class="" id="hoursField">
                <label for="hours">Продолжительность (часы)</label>
                <input id="hours" name="hours" type="number" min="1" max="10" step="1" required>
            ...
            <div class="grid">
              <div class="" id="priceField">
                ...
                <input id="price" name="price" type="text" inputmode="decimal" placeholder="100.00" required>
                <div class="help">Обязательно, формат xx.xx, не менее 100</div>
                <div class="err" id="priceError">Цена должна быть в формате xx.xx и не меньше 100</div>
              </div>
              <div class="" id="imgField">
                <label for="img">Обложка (JPG)</label>
                <input id="img" name="img" type="file" accept="image/jpeg" required>
                <div class="help">Обязательно при создании, JPG/JPEG, максимум 2000 Кб</div>
                <div class="err" id="imgError">Загрузите JPG до 2000 Кб</div>
              </div>
            </div>
            <div class="grid">
              <div class="" id="startDateField">
                <label for="start_date">Дата начала</label>
                <input id="start_date" name="start_date" type="text" placeholder="дд-мм-гггг" required>
                <div class="help">Обязательно, формат дд-мм-гггг</div>
                <div class="err" id="startDateError">Неверный формат даты</div>
              </div>
              <div class="" id="endDateField">
                <label for="end_date">Дата окончания</label>
                <input id="end_date" name="end_date" type="text" placeholder="дд-мм-гггг" required>
                <div class="help">Обязательно, формат дд-мм-гггг</div>
                <div class="err" id="endDateError">Неверный формат даты</div>
              </div>
            </div>
            <div class="" id="descriptionField">
              ...
              <div class="err" id="descriptionError">Максимум 100 символов</div>
            </div>
            <div class="actions">
