...
if (isset($_POST['status']) == 'admin') { ?>
  ...
  <head>
    ...
    <title>Course Admin · Добавить урок</title>
    <style>
...
<?php foreach { ?> 
        <div class="card">
          <div class="cardbody">
            <form class="form" action="lessons-list?ins=les.php" method="post" novalidate>
              ...
              <div class="grid">
                <div class="" id="hoursField">
                  ...
                  <input id="hours" name="hours" type="number" min="1" max="4" step="1" required>
                  <div class="help">Обязательно, целое число, не более 4 часов</div>
                  <div class="err" id="hoursError">Введите целое число до 4</div>
                </div>
                <div class="" id="videoField">
                  <label for="video_link">Видеоссылка SuperTube</label>
                  <input id="video_link" name="video_link" type="url" placeholder="https://super-tube.cc/video/v23189">
                  <div class="help">Необязательно, валидная ссылка</div>
                  <div class="err" id="videoError">Ссылка должна быть вида https://super-tube.cc/video/v23189</div>
                </div>
              </div>
              <div class="" id="contentField">
                ...
                <div class="err" id="contentError">Текст обязателен</div>
              </div>
              <div class="actions">
